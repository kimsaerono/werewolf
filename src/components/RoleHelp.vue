...
const GAME_RULES: { title: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      "守卫：每晚守一人免刀，不能连续两晚守同一人；同守同救则该玩家死亡（奶穿）",
      "狼人：共同选一人刀杀，狼情侣不可互刀",
  ...
  },
  {
    ...
    items: [
      ...
      "狼王开枪：被刀死或被放逐投票时可开枪带走一人；被毒死、殉情、白狼王带走时不能开枪",
      "猎人开枪：被狼刀死或被放逐投票时可开枪带走一人；被毒死、殉情、白狼王带走时不能开枪",
      "骑士决斗：每局一次，白天翻牌决斗：戳中狼人则狼死骑士存活，戳错则骑士死亡",
    ],
  },
  {
    title: "警长规则",
